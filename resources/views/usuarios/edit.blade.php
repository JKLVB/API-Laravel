        ...
        <div class="container">
            ...
            <form action="{{ route('usuarios-update', ['id' => $usuarios->id]) }}" method="POST">
                ...
                <div class="row mb-3" style="display: flex; justify-content: center;">
                    ...
                    <div class="col-sm-3">
                    <input type="text" pattern=".*\S+.*" class="form-control" id="nome" name="nome" value="{{ $usuarios->nome }}" placeholder="Insira seu nome" maxlength="35">
                    </div>
                </div>
                <div class="row mb-3" style="display: flex; justify-content: center;">
                    <label for="inputCpf3" class="col-sm-1 col-form-label">CPF</label>
                    <div class="col-sm-3">
                    <input type="text" class="form-control" id="cpf" name="cpf" value="{{ $usuarios->cpf }}" placeholder="Apenas números" minlength="11" maxlength="11">
                    </div>
                </div>
                <div class="row mb-3" style="display: flex; justify-content: center;">
                    <label for="inputSenha3" class="col-sm-1 col-form-label">Senha</label>
                    <div class="col-sm-3">
                    <input type="password" class="form-control" id="senha" name="senha" value="{{ $usuarios->senha }}" placeholder="Senha com 8 dígitos" minlength="8" maxlength="8">
                    </div>
                </div>
                <div class="row mb-3" style="display: flex; justify-content: center;">
                    <label for="inputSalario3" class="col-sm-1 col-form-label">Telefone</label>
                    <div class="col-sm-3">
                    <input type="text" class="form-control" id="telefone" name="telefone" value="{{ $usuarios->telefone }}" placeholder="Apenas números" minlength="11" maxlength="11">
                    </div>
                </div>
